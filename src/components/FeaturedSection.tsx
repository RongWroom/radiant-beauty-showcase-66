...
export const FeaturedSection = () => {
  return <section className="py-32 bg-gradient-to-br from-white via-skin-lightgreen/30 to-skin-lightorange/20">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {featuredTreatments.map(treatment => <div key={treatment.id} className="bg-white rounded-2xl shadow-sm overflow-hidden hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
...
export const BannerSection = () => {
  return <section className="py-32 bg-gradient-primary relative overflow-hidden">
      <div className="container-custom relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/3">
            <div className="relative">
              <img src="/placeholder.svg" alt="Skincare serum" className="w-full h-96 object-cover rounded-2xl shadow-lg" />
          ...
          <div className="lg:w-2/3 text-gray-800 space-y-8">
            ...
            <p className="text-xl leading-relaxed opacity-90 max-w-2xl">Unlock the secret to your inner beauty and energy with our natural skincare products</p>
  ...
  return <section className="py-24 bg-white">
      <div className="container-custom">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {treatments.map(treatment => <div key={treatment.id} className="bg-gradient-soft rounded-2xl p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
