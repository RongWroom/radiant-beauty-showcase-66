...
const Hero = () => (
  <section className="relative overflow-hidden bg-gradient-to-br from-brand-off-white via-white to-brand-light-gray min-h-screen flex items-center">
    {/* Background blobs */}
    ...
    <div className="container-custom mx-auto flex flex-col-reverse lg:flex-row items-center py-12 relative z-10 gap-12">
      {/* Left Column */}
      <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6">
        {/* Reviews badge */}
        <div className="inline-flex items-center bg-white/80 backdrop-blur-sm px-5 py-2 rounded-full shadow-lg animate-fade-in">
          {[...Array(5)].map((_, i) => (
        ...
        {/* Headline */}
        <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl text-brand-charcoal leading-tight">
          Polish Your<br />
      ...
      {/* Right Column (Pexels image + pixel accents) */}
      <div className="w-full lg:w-1/2 relative">
        {/* Pixel accent top-left */}
        <div className="absolute -top-4 -left-4 w-16 h-16 bg-brand-silver/20" style={{ clipPath: 'polygon(0 0, 100% 0, 0 100%)' }}></div>
        {/* Pixel accent bottom-right */}
        <div className="absolute -bottom-4 -right-4 w-20 h-20 bg-brand-slate-blue-light/20" style={{ clipPath: 'polygon(100% 0, 100% 100%, 0 100%)' }}></div>

        <img
          src="https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?auto=compress&cs=tinysrgb&w=600"
          alt="Polished natural beauty"
