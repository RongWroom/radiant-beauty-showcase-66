...
const Navbar = () => {
  ...
  const isActive = (path: string) => {
    return location.pathname === path ? "text-skin-teal font-medium" : "text-gray-800 hover:text-skin-orange";
  };

  return (
    <nav className="bg-white py-4 sticky top-0 z-50 shadow-sm border-b border-skin-green/20">
      <div className="container-custom flex justify-between items-center">
        <div className="flex items-center space-x-8">
          ...
          <div className="hidden md:flex space-x-6">
            ...
            <a href="#" className="text-gray-800 hover:text-skin-orange transition-colors">Contact</a>
          </div>
        </div>
        <div className="flex items-center space-x-4">
          ...
          <button className="p-2 hover:bg-skin-lightgreen rounded-full transition-colors relative">
            ...
            <span className="absolute -top-1 -right-1 bg-skin-orange text-xs rounded-full h-4 w-4 flex items-center justify-center text-white font-medium">
              0
            </span>
          </button>
        </div>
