...
const Hero = () => {
  return <section className="relative overflow-hidden bg-gradient-to-tr from-brand-light-gray/80 via-white to-white">
      <div className="container-custom min-h-[85vh] flex flex-col md:flex-row items-center relative z-10">
        <div className="md:w-1/2 pt-24 md:pt-0 z-10 space-y-8">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-medium leading-tight text-brand-charcoal">Welcome to STW Aesthetics</h1>
        ...
        <div className="md:w-1/2 mt-16 md:mt-0 relative">
          ...
          <img alt="STW Aesthetic Clinic logo" src="/lovable-uploads/247e14b1-74cd-4e99-9bea-37c3775cb36d.png" className="relative z-10 mx-auto h-[500px] md:h-[600px] w-full max-w-md rounded-lg object-contain p-8" />
        </div>
      </div>
