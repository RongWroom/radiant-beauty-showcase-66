...
const ValuesBanner = () => {
  return (
    <section className="relative bg-brand-sage text-white overflow-hidden">
      <div className="container-custom py-20 md:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <Button className="bg-white text-brand-sage hover:bg-brand-lime hover:text-brand-neutral-900 transition-all duration-300 shadow-lg px-10 py-4 text-lg font-medium">
              LEARN MORE
            </Button>
          </div>
          <div className="relative">
            <div className="absolute inset-0 bg-brand-lime/10 rounded-3xl"></div>
            <img 
              src="/placeholder.svg" 
      ...
      <div className="absolute top-0 right-0 h-full w-1/3 bg-gradient-to-l from-brand-lime/10 to-transparent pointer-events-none"></div>
    </section>
  );
};
